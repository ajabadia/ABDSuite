...
Entre:
[Tenant Name], en adelante, el “Responsable” o el “Tenant”, según corresponda, y [Supplier Name], en adelante, el “Encargado” o el “Proveedor”.

Fecha de entrada en vigor: [Effective Date]
Jurisdicción aplicable: [Jurisdiction]

INSTRUCCIONES DE ESTILO PARA WORD
- Título principal: estilo Título 1
- Secciones: estilo Encabezado 1
- Subsecciones: estilo Encabezado 2
- Texto contractual: estilo Normal
- Tablas: estilo de tabla sobrio con encabezado sombreado
- Numeración: mantener numeración clásica por artículos

INDICE
1. Objeto
2. Definiciones
3. Medidas de seguridad
4. Retención y supresión
5. Derechos ARSOLP
6. Brechas de seguridad
7. Subencargados
8. Transferencias internacionales
9. Auditoría y derecho de inspección
10. SLA
11. Terminación y devolución
12. Responsabilidad
13. Jurisdicción y ley aplicable
14. Firmas
15. Tabla de control interna
16. Tabla de control de cumplimiento y riesgos
...
2.1. “Datos Personales” significa cualquier información sobre una persona física identificada o identificable.
...
5.3. El Encargado documentará la recepción, tramitación y cierre de cada solicitud, con trazabilidad suficiente.
...
ARTÍCULO 15. TABLA DE CONTROL INTERNA

| Proceso | IT | DPO | Legal | Frecuencia | Evidencia |
|---|---|---|---|---|---|
| Detección y clasificación de brechas | R | C | I | Continua | Ticket, logs, trazas |
| Evaluación de riesgo | C | R | C | Por incidente | Informe de riesgo |
| Notificación a autoridad | I | A | C | Por incidente | Formulario y acuse |
| Gestión de subencargados | R | C | A | Trimestral/Anual | Registro y contratos |
| Revisión de transferencias | C | A | R | Anual | TIA/SCCs |
| Auditoría de cumplimiento | R | C | A | Anual | Informe de auditoría |
| Portabilidad y devolución | R | A | C | A solicitud / fin contrato | Exportación y acta |
| Mantenimiento de SLA | R | C | A | Mensual | KPI/SLA report |

ARTÍCULO 16. TABLA DE CONTROL DE CUMPLIMIENTO Y RIESGOS

| Riesgo | Control | Responsable | Estado | Riesgo residual | Acción |
|---|---|---|---|---|---|
| Brecha de seguridad | Playbook de incidentes y notificación | IT/DPO | Pendiente | Medio | Simulacro trimestral |
| Subencargado no autorizado | Aprobación previa y registro | Legal | Pendiente | Bajo | Revisión anual |
| Transferencia internacional no cubierta | SCCs/TIA y medidas suplementarias | Legal/DPO | Pendiente | Medio | Revisión por país |
| Retención excesiva | Política de purga y revisión | IT/DPO | Pendiente | Bajo | Auditoría semestral |
| Incumplimiento SLA | Monitorización y escalado | IT | Pendiente | Medio | Revisión mensual |
| Falta de respuesta a derechos | Workflow ARSOLP | DPO/IT | Pendiente | Bajo | Test mensual |

ESTE DOCUMENTO ES UNA PLANTILLA. AJUSTAR ANTES DE FIRMA.
