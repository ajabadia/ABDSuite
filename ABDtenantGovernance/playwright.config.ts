...
/**
 * 🎭 Playwright Industrial Configuration — ABDtenantGovernance
 ...
 * webServer auto-starts ABDtenantGovernance. Only ABDAuth needs manual startup:
 *   cd ABDAuth && npm run dev    # port 3400
 *   cd ABDtenantGovernance && pnpm test  # auto-starts port 3500 via webServer
 */
