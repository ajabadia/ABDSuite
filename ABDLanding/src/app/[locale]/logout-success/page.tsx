...
/**
 * @purpose Renderiza una página de éxito de logout utilizando el componente `LogoutSuccessView` de la biblioteca widgets de ecosistema, delegando traducciones y manejo de rutas con Next.js Link.
 ...
 * @lastUpdated 2026-06-23T23:04:54.608Z
 */
