 ...
 * @complexity Medium
 * @fingerprint exports:2,imports:4,sig:16wwao9
 * @lastUpdated 2026-07-01T12:17:01.911Z
 */
...
export const config = {
  // Intercept all routes except auth endpoints, api, static resources, and images
  matcher: ['/((?!auth|api|_next/static|_next/image|.*\\.svg$).*)'],
};
