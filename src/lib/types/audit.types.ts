...
export const EVENT_CATEGORY_MAP: Record<string, AuditCategory> = {
  ...
  CONFIG_DOC_CATALOG_SAVE: 'CONFIG',
  CONFIG_DOC_CATALOG_DELETE: 'CONFIG',
  CONFIG_DOC_CATALOG_STATUS: 'CONFIG',
  ...
  REGTECH_TIN_VALIDATION_MANUAL: 'DATA',
  REGTECH_TIN_VALIDATION_BATCH: 'DATA',
