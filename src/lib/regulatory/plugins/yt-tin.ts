...
/**
 * TIN Validation for Mayotte (YT)
 * TIN (9 digits - SIREN)
 */

/**
 * TIN Requirements for Mayotte
 */
...
export const COUNTRY_INFO: CountryRegulatoryInfo = {
    ...
    residency: {
        individual: 'Se considera residente si tiene su residencia principal en Mayotte.',
        entity: 'Se considera residente si tiene su sede legal en Mayotte.',
        notes: 'Criterio de residencia principal o sede legal.'
    }
};

/**
 * TIN Metadata for Mayotte (Era 6.3)
 */
export const TIN_INFO: TinInfo = {
    name: 'SIREN / TIN',
    description: 'Mayotte identifier, aligning with the French SIREN system.',
    placeholder: '123456789',
    officialLink: 'https://www.mayotte.gouv.fr',
    isOfficial: true,
...
/**
 * Mayotte TIN Validator - Era 6.3
 */
export const validateYTTIN = (
    value: string, 
    ...
    if (sanitized.length >= 4 && sanitized.length <= 15 && /^[A-Z0-9]+$/.test(sanitized)) {
        return { 
            ...
            explanation: 'Matches general Mayotte identifier alphanumeric format.' 
        };
    }
    ...
    return { 
        ...
        explanation: 'Value does not match Mayotte identifier format.'
    };
};
 ...
 * Mayotte uses a system aligned with the French SIREN (9 digits).
