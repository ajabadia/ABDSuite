/**
 * @purpose Gestiona subidas de archivos, valida tipos y tamaños de MIME, genera nombres únicos, almacena archivos en el servidor y devuelve detalles de éxito de la subida.
 * @purpose_en Handles file uploads, validates MIME types and sizes, generates unique names, saves files to the server, and returns upload success details.
 * @refactorable false
 * @classification Business Service
 * @complexity Medium
 * @fingerprint exports:1,imports:4,sig:1dwr8qo
 * @lastUpdated 2026-06-21T08:41:13.435Z
 */
